                    ...
                    <>
                      ...
                      >
                        ...
                        <div className="px-3 md:px-4 py-2 md:py-3 border-b border-white/10 mb-2">
                          ...
                          <div className="text-xs md:text-sm text-gray-400 truncate">john@example.com</div>
                          <div className="flex items-center gap-2 mt-2">
                            <span className="badge-success text-xs">Pro Plan</span>
                            <span className="text-xs text-gray-500">• 524 vehicles</span>
                          </div>
                        </div>
              ...
              <div className="p-4 md:p-6">
                ...
                <div className="border-t border-white/10 pt-4 md:pt-6">
                  <div className="flex items-center gap-3 px-3 md:px-4 py-2.5 md:py-3 rounded-xl bg-white/5">
                    ...
                    <div>
                      <div className="font-semibold text-sm md:text-base">John Doe</div>
                      <div className="text-xs md:text-sm text-gray-400">Fleet Manager</div>
                    </div>
                  </div>
